import "./WarehousesInventoryList.scss";
...
function WarehousesInventoryList ({name, address, city, country, contactName, contactPhone, contactEmail, warehouseId, handleClick, id}) {
